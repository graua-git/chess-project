...
class RandomTestCase(unittest.TestCase):
    def test_0(self):
        ...
        expected = 0
        self.assertEqual(result, expected, msg="Test 0 expected material difference = {}, got {}".format(expected, result))
    ...
    def test_1(self):
        ...
        result = game.get_material_difference()
        expected = 7
        self.assertEqual(result, expected, msg="Test 1 expected material difference = {}, got {}".format(expected, result))
    
    def test_2(self):
        # Me vs GMswaggyp
        starting_pos = '1. e4 e5 2. Nc3 Bc5 3. Bc4 Nc6 4. Qg4 Qf6 5. Nd5 Qxf2 6. Kd1 Na5 7. Nh3 Qd4 8. d3 Nxc4 9. c3 Qxd3 10. Ke1 Nf6 \
        ...
        result = game.get_material_difference()
        expected = 8
        self.assertEqual(result, expected, msg="Test 2 expected material difference = {}, got {}".format(expected, result))
    
    def test_3(self):
        # Me vs ManuSd1998
        starting_pos = '1. e4 e6 2. Nc3 Qf6 3. Nf3 d5 4. exd5 exd5 5. d3 c6 6. Be2 Bb4 7. O-O Bxc3 8. bxc3 Qxc3 9. Rb1 Ne7 10. Bb2 Qa5 \
        ...
        result = game.get_material_difference()
        expected = 19
        self.assertEqual(result, expected, msg="Test 3 expected material difference = {}, got {}".format(expected, result))
    ...
    def test_4(self):
        ...
        result = game.get_material_difference()
        expected = -8
        self.assertEqual(result, expected, msg="Test 4 expected material difference = {}, got {}".format(expected, result))
    
    def test_5(self):
        # alterfiend vs Me
        starting_pos = '1. e4 c6 2. Nf3 d5 3. Nc3 Bg4 4. exd5 cxd5 5. h3 Bxf3 6. Qxf3 e6 7. Bb5 Nc6 8. O-O Nf6 9. d4 a6 10. Ba4 b5 \
        ...
        result = game.get_material_difference()
        expected = 6
        self.assertEqual(result, expected, msg="Test 5 expected material difference = {}, got {}".format(expected, result))

    def test_6(self):
        starting_pos = '1. e4 e5 2. Nc3 Nf6 3. f4 d6 4. Nf3 Nc6 5. Bc4 Qe7 6. O-O Be6 7. Bb3 Bxb3 8. axb3 h6 9. d3 g5 10. fxe5 Nxe5 \
    ...
    def test_7(self):
        # lukaszkalisz vs Me
        starting_pos = '1. e4 c6 2. Nc3 d5 3. exd5 cxd5 4. Nf3 Nc6 5. Bb5 Bg4 6. O-O e6 7. d3 Nf6 8. h3 Bxf3 9. Qxf3 Bd6 \
