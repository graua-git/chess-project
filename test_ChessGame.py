...
# N/A
game_0_moves = ''
game_0 = ChessGame(game_0_moves)

# andrewmcleodnz vs Me
game_1_moves = '1. c4 c5 2. Nc3 Nc6 3. g3 g6 4. Bg2 Bg7 5. e3 Nf6 6. Nge2 O-O 7. O-O Qb6 8. b3 d6 9. d4 Bg4 10. f3 Bd7 \
...
game_1 = ChessGame(game_1_moves)

# Me vs GMswaggyp
game_2_moves = '1. e4 e5 2. Nc3 Bc5 3. Bc4 Nc6 4. Qg4 Qf6 5. Nd5 Qxf2 6. Kd1 Na5 7. Nh3 Qd4 8. d3 Nxc4 9. c3 Qxd3 10. Ke1 Nf6 \
                    ...
                    31. Rxd6 Kb7 32. Rxd8'
game_2 = ChessGame(game_2_moves)

# Me vs ManuSd1998
game_3_moves = '1. e4 e6 2. Nc3 Qf6 3. Nf3 d5 4. exd5 exd5 5. d3 c6 6. Be2 Bb4 7. O-O Bxc3 8. bxc3 Qxc3 9. Rb1 Ne7 10. Bb2 Qa5 \
...
game_3 = ChessGame(game_3_moves)

# LaGuinze vs Me
game_4_moves = '1. e4 c6 2. e5 d5 3. exd6 exd6 4. Qe2 Qe7 5. Qxe7 Bxe7 6. Nf3 Bg4 7. Be2 Nf6 8. d3 h6 9. O-O O-O 10. h3 Bh5 \
...
game_4 = ChessGame(game_4_moves)

# alterfiend vs Me
game_5_moves = '1. e4 c6 2. Nf3 d5 3. Nc3 Bg4 4. exd5 cxd5 5. h3 Bxf3 6. Qxf3 e6 7. Bb5 Nc6 8. O-O Nf6 9. d4 a6 10. Ba4 b5 \
...
game_5 = ChessGame(game_5_moves)

game_6_moves = '1. e4 e5 2. Nc3 Nf6 3. f4 d6 4. Nf3 Nc6 5. Bc4 Qe7 6. O-O Be6 7. Bb3 Bxb3 8. axb3 h6 9. d3 g5 10. fxe5 Nxe5 \
                    ...
                    61. Qb2 Ka4 62. Qb4'
game_6 = ChessGame(game_6_moves)

# lukaszkalisz vs Me
game_7_moves = '1. e4 c6 2. Nc3 d5 3. exd5 cxd5 4. Nf3 Nc6 5. Bb5 Bg4 6. O-O e6 7. d3 Nf6 8. h3 Bxf3 9. Qxf3 Bd6 \
...
game_7 = ChessGame(game_7_moves)

# lvpstn vs Me
game_8_moves = '1. e4 c6 2. f4 d5 3. e5 Bf5 4. Nf3 e6 5. d4 c5 6. Bd3 Bg6 7. O-O Nc6 8. c3 cxd4 9. cxd4 Qb6 10. Be3 Qxb2 \
                    ...
                    41. e6 Qxg2'
game_8 = ChessGame(game_8_moves)

# Krageven vs Me
game_9_moves = '1. e4 e5 2. f4 exf4 3. Nf3 Nf6 4. Nc3 Nc6 5. Bc4 Bc5 6. d4 Bb6 7. O-O O-O 8. Bxf4 d5 9. Bd3 dxe4 10. Nxe4 Re8 \
                    ...
                    31. Qxc7 b5 32. Qc8'
game_9 = ChessGame(game_9_moves)

# Me vs Danijejela
game_10_moves = '1. e4 e5 2. f4 f6 3. fxe5 fxe5 4. Nf3 d6 5. Bc4 Qf6 6. O-O h6 7. Nc3 a6 8. Nd5 Qd8 9. d3 c6 10. Nb6 Qxb6 \
...
game_10 = ChessGame(game_10_moves)
t2 = time.time()
...
class TestTime(unittest.TestCase):
    def test_time(self):
        result = t2 - t1
        expected = 25
        self.assertLess(result, expected, msg="Time taken to complete 10 games: {}".format(result))
        print(f"Time taken to run tests: {result}s")

class TestMaterialDifference(unittest.TestCase):
    def test_game_0(self):
        result = game_0.get_material_difference()
        expected = 0
        self.assertEqual(result, expected, msg="Game 0 expected material difference = {}, got {}".format(expected, result))
    
    def test_game_1(self):
        result = game_1.get_material_difference()
        expected = 7
        self.assertEqual(result, expected, msg="Game 1 expected material difference = {}, got {}".format(expected, result))
    
    def test_game_2(self):
        result = game_2.get_material_difference()
        expected = 8
        self.assertEqual(result, expected, msg="Game 2 expected material difference = {}, got {}".format(expected, result))
    
    def test_game_3(self):
        result = game_3.get_material_difference()
        expected = 19
        self.assertEqual(result, expected, msg="Game 3 expected material difference = {}, got {}".format(expected, result))

    def test_game_4(self):
        result = game_4.get_material_difference()
        expected = -8
        self.assertEqual(result, expected, msg="Game 4 expected material difference = {}, got {}".format(expected, result))
    
    def test_game_5(self):
        result = game_5.get_material_difference()
        expected = 6
        self.assertEqual(result, expected, msg="Game 5 expected material difference = {}, got {}".format(expected, result))

    def test_game_6(self):
        result = game_6.get_material_difference()
        expected = 18
        self.assertEqual(result, expected, msg="Game 6 expected material difference = {}, got {}".format(expected, result))

    def test_game_7(self):
        result = game_7.get_material_difference()
        expected = -4
        self.assertEqual(result, expected, msg="Game 7 expected material difference = {}, got {}".format(expected, result))

    def test_game_8(self):
        result = game_8.get_material_difference()
        expected = -10
        self.assertEqual(result, expected, msg="Game 8 expected material difference = {}, got {}".format(expected, result))
    
    def test_game_9(self):
        result = game_9.get_material_difference()
        expected = 16
        self.assertEqual(result, expected, msg="Game 9 expected material difference = {}, got {}".format(expected, result))
    
    def test_game_10(self):
        result = game_10.get_material_difference()
        expected = -15
        self.assertEqual(result, expected, msg="Game 10 expected material difference = {}, got {}".format(expected, result))

class TestWinner(unittest.TestCase):
    def test_game_0(self):
        result = game_0.get_winner()
        expected = None
        self.assertEqual(result, expected, msg="Game 0 expected winner: {}, got {}".format(expected, result))
    
    def test_game_1(self):
        result = game_1.get_winner()
        expected = None
        self.assertEqual(result, expected, msg="Game 0 expected winner: {}, got {}".format(expected, result))

    def test_game_2(self):
        result = game_2.get_winner()
        expected = None
        self.assertEqual(result, expected, msg="Game 0 expected winner: {}, got {}".format(expected, result))

    def test_game_3(self):
        result = game_3.get_winner()
        expected = 'W'
        self.assertEqual(result, expected, msg="Game 0 expected winner: {}, got {}".format(expected, result))

    def test_game_4(self):
        result = game_4.get_winner()
        expected = None
        self.assertEqual(result, expected, msg="Game 0 expected winner: {}, got {}".format(expected, result))

    def test_game_5(self):
        result = game_5.get_winner()
        expected = None
        self.assertEqual(result, expected, msg="Game 0 expected winner: {}, got {}".format(expected, result))

    def test_game_6(self):
        result = game_6.get_winner()
        expected = 'W'
        self.assertEqual(result, expected, msg="Game 0 expected winner: {}, got {}".format(expected, result))

    def test_game_7(self):
        result = game_7.get_winner()
        expected = 'B'
        self.assertEqual(result, expected, msg="Game 0 expected winner: {}, got {}".format(expected, result))

    def test_game_8(self):
        result = game_8.get_winner()
        expected = None
        self.assertEqual(result, expected, msg="Game 0 expected winner: {}, got {}".format(expected, result))

    def test_game_9(self):
        result = game_9.get_winner()
        expected = 'W'
        self.assertEqual(result, expected, msg="Game 0 expected winner: {}, got {}".format(expected, result))

    def test_game_10(self):
        result = game_10.get_winner()
        expected = 'B'
        self.assertEqual(result, expected, msg="Game 0 expected winner: {}, got {}".format(expected, result))
